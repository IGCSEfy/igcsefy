(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '  white-space: nowrap;',
      '}',
      '[data-igcsefy-tracked-count-number] {',
      ...
      '}',
      '@keyframes igcsefySubjectSelect {',
      '  0% { transform: scale(0.985); }',
      '  60% { transform: scale(1.01); }',
      '  100% { transform: scale(1); }',
      '}',
      '@keyframes igcsefySubjectLevelSet {',
      '  0% { transform: scale(0.94); }',
      '  65% { transform: scale(1.015); }',
      '  100% { transform: scale(1); }',
      '}',
      '@keyframes igcsefySubjectPillPop {',
      '  0% { transform: scale(0.94) translateY(2px); opacity: 0.9; }',
      '  100% { transform: scale(1) translateY(0); opacity: 1; }',
      '}',
      '@keyframes igcsefySubjectManagerReveal {',
      ...
      '  transition: border-color 0.18s ease, background-color 0.18s ease, box-shadow 0.18s ease, transform 0.22s cubic-bezier(0.22, 1, 0.36, 1) !important;',
      '}',
      'button[data-igcsefy-profile-subject-card="true"][data-selected="true"] {',
      '  animation: igcsefySubjectSelect 220ms cubic-bezier(0.22, 1, 0.36, 1);',
      '}',
      'button[data-igcsefy-profile-subject-card="true"]:hover {',
      '  transform: translateY(-2px);',
      '}',
      'button[data-igcsefy-profile-subject-card="true"]:active {',
      ...
      '  flex-shrink: 0;',
      '  transform: scale(1);',
      '  transition: background-color 0.18s ease, border-color 0.18s ease, color 0.18s ease, transform 0.22s cubic-bezier(0.22, 1, 0.36, 1), box-shadow 0.22s ease;',
      '}',
      'button[data-igcsefy-profile-subject-card="true"][data-selected="true"] [data-igcsefy-subject-card-check] {',
      '  transform: scale(1.04);',
      '  box-shadow: var(--igcsefy-subject-selector-shadow-sm);',
      '}',
      ...
      '  border-radius: 999px;',
      '  transform: scale(1);',
      '  transition: opacity 0.18s ease, filter 0.18s ease, transform 0.22s cubic-bezier(0.22, 1, 0.36, 1), background-color 0.18s ease, border-color 0.18s ease;',
      '}',
      ...
      '  user-select: none;',
      '  transform: scale(1);',
      '  transition: background-color 0.18s ease, color 0.18s ease, box-shadow 0.18s ease, transform 0.22s cubic-bezier(0.22, 1, 0.36, 1);',
      '}',
      'button[data-igcsefy-profile-subject-card="true"][data-selected="false"] [data-igcsefy-subject-level] {',
      '  pointer-events: none;',
      '}',
      'button[data-igcsefy-profile-subject-card="true"][data-selected="true"] [data-igcsefy-subject-level][data-active="true"] {',
      '  animation: igcsefySubjectLevelSet 210ms cubic-bezier(0.22, 1, 0.36, 1);',
      '}',
      ...
      '  transition: border-color 0.18s ease, background-color 0.18s ease, box-shadow 0.18s ease, transform 0.22s cubic-bezier(0.22, 1, 0.36, 1) !important;',
      '}',
      'button[data-igcsefy-basic-subject-option="true"][data-selected="true"] {',
      '  animation: igcsefySubjectSelect 220ms cubic-bezier(0.22, 1, 0.36, 1);',
      '}',
      'button[data-igcsefy-basic-subject-option="true"]:hover {',
      '  transform: translateY(-2px);',
      '}',
      'button[data-igcsefy-basic-subject-option="true"]:active {',
      '  transform: scale(0.992);',
      '}',
      ...
      '  transition: background-color 0.18s ease, border-color 0.18s ease, color 0.18s ease, transform 0.22s cubic-bezier(0.22, 1, 0.36, 1), box-shadow 0.22s ease;',
      '}',
      'button[data-igcsefy-basic-subject-option="true"][data-selected="true"] [data-igcsefy-basic-subject-check] {',
      '  transform: scale(1.04);',
      '  box-shadow: var(--igcsefy-subject-selector-shadow-sm);',
      '}',
      ...
      '  will-change: transform, box-shadow;',
      '  transition: background-color 0.18s ease, color 0.18s ease, border-color 0.18s ease, box-shadow 0.18s ease, transform 0.2s cubic-bezier(0.22, 1, 0.36, 1) !important;',
      '}',
      ...
      '}',
      'html.light #root div.flex.items-end.justify-between > button.flex.items-center.gap-2.text-\\[13px\\].font-medium.px-4.py-2.rounded-full.transition-colors.duration-150:active,',
      'html[data-theme="light"] #root div.flex.items-end.justify-between > button.flex.items-center.gap-2.text-\\[13px\\].font-medium.px-4.py-2.rounded-full.transition-colors.duration-150:active {',
      ...
      '  box-shadow: var(--igcsefy-subject-selector-shadow-sm) !important;',
      '  animation: igcsefySubjectPillPop 180ms cubic-bezier(0.22, 1, 0.36, 1);',
      '}',
      ...
      '  transform: translateY(0) scale(1) !important;',
      '  will-change: transform, box-shadow;',
      '  transition: background-color 0.18s ease, color 0.18s ease, box-shadow 0.18s ease, transform 0.2s cubic-bezier(0.22, 1, 0.36, 1) !important;',
      '  animation: igcsefySubjectPillPop 180ms cubic-bezier(0.22, 1, 0.36, 1);',
      '}',
      ...
      '  transform: translateY(-1px) scale(1.01) !important;',
      '}',
      'html.light #root div.px-4.py-3.flex.items-center.justify-between > button.text-\\[12px\\].font-medium.px-4.py-1\\.5.rounded-full.transition-colors.duration-150:active,',
      'html[data-theme="light"] #root div.px-4.py-3.flex.items-center.justify-between > button.text-\\[12px\\].font-medium.px-4.py-1\\.5.rounded-full.transition-colors.duration-150:active {',
      '  transform: scale(0.97) !important;',
      '}',
      ...
      '  transform: translateY(-1px) scale(1.01) !important;',
      '}',
      'html.light [data-igcsefy-subject-manager-toggle="true"]:active,',
      'html[data-theme="light"] [data-igcsefy-subject-manager-toggle="true"]:active {',
      '  transform: scale(0.97) !important;',
      '}',
      ...
      '  animation: igcsefySubjectManagerReveal 220ms cubic-bezier(0.22, 1, 0.36, 1);',
      '}',
      ...
      '  transform: translateY(-1px) scale(1.01) !important;',
      '}',
      'html.light [data-igcsefy-subject-group-pill="true"]:active,',
      'html[data-theme="light"] [data-igcsefy-subject-group-pill="true"]:active {',
      '  transform: scale(0.97) !important;',
      '}',
      ...
      '  transform: translateY(-1px) scale(1.01) !important;',
      '}',
      'html.light [data-igcsefy-subject-manager-confirm="true"]:active,',
      'html[data-theme="light"] [data-igcsefy-subject-manager-confirm="true"]:active {',
      '  transform: scale(0.97) !important;',
      '}',
  ...
  function tagTrackedCount(root) {
    ...
    for (i = 0; i < paragraphs.length; i += 1) {
      ...
      paragraph.innerHTML = [
        '<span data-igcsefy-tracked-count-number>',
        escapeHtml(match[1]),
        '</span> ',
        '<span data-igcsefy-tracked-count-label>tracked</span>'
      ].join('');
    }
  }
